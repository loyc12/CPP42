...
PresidentialPardonForm::PresidentialPardonForm(const std::string _target)
{
	...
	std::cout << "Constructed presidential pardon form for " << this->target << " ( grade " << this->getSignGrade() << "/" << this->getExecGrade() << " )" << std::endl;
}
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm &other)
{
	...
	std::cout << "Copied presidential pardon form for " << this->target << " ( grade " << this->getSignGrade() << "/" << this->getExecGrade() << " )" << std::endl;
}
